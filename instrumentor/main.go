...
import (
	...
	"github.com/logzio/app-type-detector/instrumentor/controllers"
...
func main() {
	...
	var appDetectorTag string
	var appDetectorImage string
	var deleteAppDetectionPods bool
	...
	if err = (&controllers.AppDetectorReconciler{
		Client:                mgr.GetClient(),
		Scheme:                mgr.GetScheme(),
		AppDetectorTag:        appDetectorTag,
		AppDetectorImage:      appDetectorImage,
		DeleteAppDetectorPods: deleteAppDetectionPods,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "AppDetector")
		os.Exit(1)
	}
	...
	setupLog.Info("Successfully added health check")
	...
	setupLog.Info("Successfully added ready check")
